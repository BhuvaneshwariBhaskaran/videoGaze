...
checkpoint = torch.load('./savedmodels/gazenet_gazefollow_highcrop_Hope_20epoch.pth.tar',map_location=lambda storage, loc: storage)
...
for imname in imglist:
    ...
    xis = Variable(faces.cpu())
    eye_coords = Variable(eye_coords.cpu())
