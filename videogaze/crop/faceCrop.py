...
for f in faces.items():
    ...
    csvFile.write(','.join(['StageName', 'InputFile', 'OutputFile']) + '\n');

    csvFile.write(','.join(['Face Cropping', videoFile, videoName]) + '\n');
